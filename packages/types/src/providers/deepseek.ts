...
export const deepSeekModels = {
	...
	"deepseek-reasoner": {
		maxTokens: 65_536, // 64K max output (default 32K) - Updated Dec 15, 2025
		contextWindow: 128_000,
		supportsImages: false,
		supportsPromptCache: true,
		supportsNativeTools: true,
		...
		cacheWritesPrice: 0.28, // $0.28 per million tokens (cache miss) - Updated Dec 9, 2025
		cacheReadsPrice: 0.028, // $0.028 per million tokens (cache hit) - Updated Dec 9, 2025
		description: `DeepSeek-V3.2 (Thinking Mode) achieves performance comparable to OpenAI-o1 across math, code, and reasoning tasks. Supports Chain of Thought reasoning with up to 64K output tokens (default 32K). Supports JSON output, tool calls, and chat prefix completion (beta).`,
	},
