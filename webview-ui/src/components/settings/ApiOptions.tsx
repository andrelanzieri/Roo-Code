...
const ApiOptions = ({
	...
	// Show the tool protocol selector when:
	// 1. Model explicitly supports native tools, OR
	// 2. Provider is OpenAI Compatible or Ollama (to allow user control for custom models)
