...
package ai.roocode.jetbrains.ui
...
import ai.roocode.jetbrains.actions.OpenDevToolsAction
import ai.roocode.jetbrains.plugin.WecoderPlugin
import ai.roocode.jetbrains.plugin.WecoderPluginService
import ai.roocode.jetbrains.plugin.DEBUG_MODE
import ai.roocode.jetbrains.webview.DragDropHandler
import ai.roocode.jetbrains.webview.WebViewCreationCallback
import ai.roocode.jetbrains.webview.WebViewInstance
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                append("<p>Roo Code is initializing...")
        ...
        private val knownIssuesButton = JButton("Known Issues").apply {
            ...
            addActionListener {
                ...
                BrowserUtil.browse("https://roocode.ai/docs")
            }
        }
