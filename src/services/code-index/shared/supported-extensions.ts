...
export const fallbackExtensions = [
	...
	".p", // OpenEdge ABL - no WASM parser available
	".i", // OpenEdge ABL include file - no WASM parser available
	".w", // OpenEdge ABL window file - no WASM parser available
	".cls", // OpenEdge ABL class file - no WASM parser available
	".df", // OpenEdge Data Definition - no WASM parser available
]
